...
void test_retained_message_detection()
{
    ...
    std::thread t([]()
        ...
        PubSubClient::simulateIncoming(("clients/test/command"), ("hello")); });

    bool exists = retainedMessageExists("clients/test/command", 1500);
    t.join();
